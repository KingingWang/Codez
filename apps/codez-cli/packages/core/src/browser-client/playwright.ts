...
} from "@codez/contracts/browser-control";
...
const locatorDetails = Symbol("codez.playwright.locatorDetails");
const setObjectWrapper = Symbol("codez.playwright.setObjectWrapper");
