...
export const enUS: CodezCopy = {
  ...
  cli: {
    ...
    help: (version) => `codez ${version}

Usage:
  codez [command] [options]

With no command, codez opens the full-screen TUI.

Commands:
  app-server Run the Codez Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      ...
      starting: "Starting Codez... Ctrl+C to exit",
    },
    transcript: {
      compact: {
