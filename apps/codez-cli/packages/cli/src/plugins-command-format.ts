import { formatJson } from "@codez/core";
import type { GlobalOptions, JsonValue, RunContext } from "@codez/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly CodezAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly CodezMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetCodezPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetCodezPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: CodezAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: CodezInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: CodezMarketplaceSummaryData) {
  return {
    id: marketplace.id,
