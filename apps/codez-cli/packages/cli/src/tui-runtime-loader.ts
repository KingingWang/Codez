...
import type { runTui } from "@codez/tui";
...
const assetPrefix = "codez-tui-runtime/";
const manifestAssetKey = `${assetPrefix}manifest.json`;
const packageEntryPath = "node_modules/@codez/tui/dist/index.js";
