...
import type { SupportedLocale, UiLocale } from "@codez/i18n";
import type { ModelSelection, CodezModelOption } from "@codez/shared";
import type {
...
export type CommandCenterModelOption = CodezModelOption;
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@codez/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@codez/tui").TuiReadSubagentTranscript;
