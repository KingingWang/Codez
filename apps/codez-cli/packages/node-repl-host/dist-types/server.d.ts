...
import { type NodeReplRequestMeta, type NodeReplRunResult } from "@codez/core/repl";
import { type ComputerUseRuntime } from "@codez/codez-cua";
...
export declare const NODE_REPL_MCP_PROCESS_TITLE = "codez-node-repl-mcp";
