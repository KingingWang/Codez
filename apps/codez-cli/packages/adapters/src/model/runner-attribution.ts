...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@codez/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-codez-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-codez-session-type";
