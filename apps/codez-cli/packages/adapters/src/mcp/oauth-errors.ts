 ...
 */
const INTERACTIVE_REQUIRED_BRAND = Symbol.for("codez.mcp.oauth.interactiveAuthorizationRequired");
const TEMPORARY_REFRESH_FAILURE_BRAND = Symbol.for("codez.mcp.oauth.temporaryRefreshFailure");
