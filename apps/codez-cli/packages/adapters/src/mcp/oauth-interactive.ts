...
import type { Logger, McpOAuthConfig } from "@codez/contracts";
import {
...
class InteractiveAuthorizationProvider implements OAuthClientProvider {
  ...
  private readonly credentialStore: SharedCodezCredentialStore;
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      client_name: this.config.clientName ?? `Codez ${this.serverName}`,
