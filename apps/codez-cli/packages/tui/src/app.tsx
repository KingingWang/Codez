import type { ModelUsageSummary, TodoItem, TurnId } from "@codez/contracts";
import { getCodezCopy } from "@codez/i18n";
...
export function TuiApp({
  ...
  const initialCopy = getCodezCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getCodezCopy(locale), [locale]);
