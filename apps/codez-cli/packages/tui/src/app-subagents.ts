...
import { SessionEventType, type SessionEvent } from "@codez/contracts";
import type {
  CodezSessionSubagentsResult,
  CodezSessionRunningSubagent,
...
export type SubagentItem = CodezSessionRunningSubagent | CodezSessionEndedSubagent;
const EMPTY_DIRECTORY: CodezSessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
