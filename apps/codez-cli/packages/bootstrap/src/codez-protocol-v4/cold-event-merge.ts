...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@codez/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@codez/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@codez/contracts").MessageId;
      keptMessageIDs?: import("@codez/contracts").MessageId[];
      targetMessageID?: import("@codez/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@codez/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@codez/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@codez/contracts").SessionId;
