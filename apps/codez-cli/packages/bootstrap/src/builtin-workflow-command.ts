import { expandCustomCommandPrompt, type CustomCommandContent } from "@codez/contracts";
import { BUILTIN_CODEZ_SLASH_COMMAND_HELP_ENTRIES } from "@codez/shared";
...
const helpEntry = BUILTIN_CODEZ_SLASH_COMMAND_HELP_ENTRIES.find(
