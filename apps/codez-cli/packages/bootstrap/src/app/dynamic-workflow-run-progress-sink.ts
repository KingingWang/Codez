...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@codez/contracts";
 ...
 *
 *   CodezApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
