import { ModelErrorCode, ModelProtocolError } from "@codez/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): CodezModelOption {
