...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@codez/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@codez/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@codez/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（Codez Protocol session/create 或 CLI
