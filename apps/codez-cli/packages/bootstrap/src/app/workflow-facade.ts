...
import { createNodeExecutionAdapter } from "@codez/adapters/exec";
...
import type { PrepareUserExecutionBoundary, CodezAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "codez-expert" : "codez-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "codez-expert" : "codez-workflow",
