import { createDefaultFileWorkspaceHookTrustStore } from "@codez/adapters/storage";
import {
...
import { SessionEventType } from "@codez/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@codez/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.codez/security。 */
  homeDir?: string;
