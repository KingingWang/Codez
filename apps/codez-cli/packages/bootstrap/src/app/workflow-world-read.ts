...
//      归这一侧。
//   2. **上限的执行**。常量在纯包（`@codez/dynamic-workflow` 的 WORLD_READ_CAPS），执行在这里，
...
import type { ExecutionPort, FileSystemPort } from "@codez/contracts";
import { WORLD_READ_CAPS, WorkflowError, type WorldReadOp } from "@codez/dynamic-workflow";
import {
