import type { McpServerConfig, PluginLoadOutcome } from "@codez/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { CODEZ_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { CODEZ_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
