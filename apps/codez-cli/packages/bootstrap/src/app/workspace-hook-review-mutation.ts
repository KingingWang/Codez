...
import { digestSummary, workspaceIdentitySummary } from "@codez/core";
import {
...
} from "@codez/shared/workspace-hook-mutation";
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(workingDirectory, ".codez", "config.json");
