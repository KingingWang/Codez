import type { EmbeddedSearchBackend } from "@codez/contracts";
import { getRuntimeToolRuntime } from "@codez/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "CODEZ_EMBEDDED_SEARCH_COMMAND";
