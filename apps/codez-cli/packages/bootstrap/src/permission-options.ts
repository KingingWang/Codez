import type { PermissionOptionsPolicy, PermissionUpdate } from "@codez/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type CodezPermissionOption } from "@codez/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 codezPermissionUpdateSchema 是 strict，会话语义由
