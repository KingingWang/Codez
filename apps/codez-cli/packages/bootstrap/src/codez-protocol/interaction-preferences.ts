import { codezWorkspaceUpdateInteractionPreferencesParamsSchema } from "@codez/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(codezWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
