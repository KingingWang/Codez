import { codezWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@codez/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(codezWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
