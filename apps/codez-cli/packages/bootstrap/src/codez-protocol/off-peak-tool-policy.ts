import { codezWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@codez/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(codezWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
