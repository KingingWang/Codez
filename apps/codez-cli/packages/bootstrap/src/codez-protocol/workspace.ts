import { parseRemoteWorkspaceIdentity, type CodezWorkspaceRef } from "@codez/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): CodezWorkspaceRef {
