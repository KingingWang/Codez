import {
  codezProviderUpdateAccountConfigParamsSchema,
  type CodezProviderUpdateAccountConfigResult,
} from "@codez/shared";
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<CodezProviderUpdateAccountConfigResult> {
  const envelope = parseParams(codezProviderUpdateAccountConfigParamsSchema, params);
