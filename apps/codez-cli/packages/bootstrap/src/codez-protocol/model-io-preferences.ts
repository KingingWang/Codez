import { codezWorkspaceUpdateModelIoPreferencesParamsSchema } from "@codez/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(codezWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
