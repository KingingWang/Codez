...
import { getCodezAgentModeSelectOptions, normalizeAvailableCodezMode } from "@codez/shared";
import type { CodezSessionSettingsState, CodezSlashCommand } from "@codez/shared";
import type { WorkspaceConfigState } from "@codez/shared/codez-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpCodezAgent 的注释）。
