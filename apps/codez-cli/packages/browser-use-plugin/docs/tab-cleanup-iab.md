...
- IAB tabs persist for the lifetime of the current Codez process. Turn end, session end, an omitted finalize call,
...
- Codez does not restore these tabs after the Codez process exits.
