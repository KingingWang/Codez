...
import { modelSelectionSchema, type ModelSelection } from "@codez/shared/model-selection";
import type { ModelPropertiesData, ModelOptionSpecsData } from "@codez/shared/model-config";

export type { ModelSelection } from "@codez/shared/model-selection";
...
} from "@codez/shared/model-config";
