...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@codez/codez-cua/broker/server";
...
/**
 * Parse a `codez-cua-windows-dev/v1` control message from the helper child.
 *
