...
import { z } from "zod";
import type { OffPeakTakeNumberAvailability } from "@codez/shared";
import type { ServiceLogger } from "../logger/serviceLogger.js";
import {
  withRequestIdHeader,
  REQUEST_ID_HEADER_NAME,
} from "#src/providers/api/requestIdHeaders.js";
import { buildCodezSourceHeaders } from "#src/providers/sourceHeaders.js";
import {
...
interface OffPeakServerClientDeps {
  /** API origin（真实服务端或 mock 网关，CODEZ_OFFPEAK_MOCK 切换在装配层）；mock 网关懒启动故允许异步。 */
