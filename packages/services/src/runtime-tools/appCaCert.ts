...
const APP_CA_CERT_FILE = "codez-network-ca.pem";
const APP_CA_KEY_FILE = "codez-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "Codez Network CA" },
    { name: "organizationName", value: "Codez" },
  ];
