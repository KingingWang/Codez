import type { Hook, CodezWorkspaceHookTrustGrantResult } from "@codez/shared";
import type { WorkspaceHookBundleSnapshotData } from "@codez/shared/workspace-hook-discovery";
