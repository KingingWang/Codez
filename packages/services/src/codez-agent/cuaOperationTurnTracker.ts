import { resolveWorkspaceKey, type CodezComputerUseOperationEvent } from "@codez/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: CodezComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: CodezComputerUseOperationEvent,
  ): void {
