import type { ServiceAuthorityMode } from "@codez/shared";

export type CodezAgentPresentationSurface = "desktop";

interface CodezAgentPresentationHostFacts {
...
export function resolveCodezAgentPresentationSurface(
  facts: CodezAgentPresentationHostFacts,
): CodezAgentPresentationSurface | undefined {
