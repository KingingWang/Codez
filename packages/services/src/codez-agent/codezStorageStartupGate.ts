...
export class CodezStorageStartupGate {
  private current?: CodezStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<CodezStorageStartupState>();
  ...
  get snapshot(): CodezStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = codezStorageStartupStateSchema.safeParse(input);
