import { z } from "zod";
import { modelConfigDataSchema } from "@codez/shared/model-config";
...
export function parseCodezBuiltinProviderConfigMap(input: unknown): ProviderConfigMap {
...
export function parseCodezBuiltinProviderConfigRules(input: unknown): {
...
export function parseCodezBuiltinModelConfigRules(input: unknown): ModelConfigRules {
