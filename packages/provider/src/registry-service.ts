...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnCodezBuiltinRevision !== config.codezBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          codezBuiltinProviders: config.codezBuiltinProviders,
          codezBuiltinProviderTemplates: config.codezBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          codezBuiltinModelRules: config.codezBuiltinModelRules,
