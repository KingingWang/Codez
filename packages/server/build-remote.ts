...
const buildResult = await build({
  ...
  bundle: true,
  outfile: "dist/remote/codez-server.cjs",
  platform: "node",
  format: "cjs",
  target: "node22",
...
const remoteBundleSource = readFileSync("dist/remote/codez-server.cjs", "utf-8");
...
console.log("Built dist/remote/codez-server.cjs");
