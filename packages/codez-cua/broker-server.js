...
export const HELPER_ADDON_ENV = "CODEZ_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "codez-cua-windows-dev/v1";
...
export function isPotentialCodezCuaAgentMcpServer(_server) {
  return false;
}
