...
export const BROKER_SOCKET_ENV = "CODEZ_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "CODEZ_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `codez-cua-broker-${randomUUID()}.sock`);
}
