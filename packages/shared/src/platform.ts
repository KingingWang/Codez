...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "codez-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "codez-media";
...
export interface CodezStdioTapDevState {
  enabled: boolean;
  visible: boolean;
  logDir: string;
  statePath: string;
...
export const DesktopCommandIds = {
  ...
  ToggleCodezStdioTapDevProxy: "toggleCodezStdioTapDevProxy",
  SetCodezEndpointProduction: "setCodezEndpointProduction",
  SetCodezEndpointTest: "setCodezEndpointTest",
  SetCodezEndpointCustom: "setCodezEndpointCustom",
  ResetCodezEndpoint: "resetCodezEndpoint",
...
export interface IPlatformService {
  ...
  /** 打开 Codez Computer Use 的完整权限引导。Desktop only。 */
  ...
  /** 导出日志：打包 ~/.codez/v2 及外部 agent 日志为 zip 并在系统文件浏览器中显示 */
