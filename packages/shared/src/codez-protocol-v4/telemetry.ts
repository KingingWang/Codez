import { z } from "zod";
import { codezSyntheticUserMessageSourceSchema } from "../codez-protocol-legacy-types.js";
...
const turnStartedFactSchema = z
  .object({
    ...
    inputSource: codezSyntheticUserMessageSourceSchema.optional(),
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "codez", "bundled", "plugin", "remote"]).optional(),
...
type TurnStartedConversationTelemetryFact = Extract<
  ...
  { kind: "turn.started" }
> &
  import("../codez-task-types-core.js").CodezBackgroundTurnAttribution;
