...
export interface SkillSummary {
   ...
   * 软链导入的技能里 `path` 是 realpath 后的目标文件，`sourcePath` 才指向 `~/.codez/skills/<name>` 下的链接本体，
...
/** 与 codez-cli `SkillDiagnosticCode` 同步。变动时一并改 apps/codez-cli/packages/contracts/src/skills/index.ts。 */
