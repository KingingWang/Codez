export const CODEZ_AGENT_PROVIDER_NOT_READY_CODE = "CODEZ_AGENT_PROVIDER_NOT_READY" as const;
export const CODEZ_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
