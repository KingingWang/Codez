...
/** 凭据解密失败稳定错误码 */
export const CREDENTIAL_DECRYPT_ERROR_CODE = "CODEZ_CREDENTIAL_DECRYPT_FAILED" as const;
...
/** Host 在检测到 Codez JWT 失效后通知 Renderer 展示确认并重启。 */
export const CODEZ_JWT_INVALID_BROADCAST_CHANNEL = "auth:codez-jwt-invalid";
