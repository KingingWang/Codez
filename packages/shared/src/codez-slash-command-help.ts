export type BuiltinCodezSlashCommandHelpEntry = {
...
export const BUILTIN_CODEZ_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinCodezSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    {
      details: ["Deletes Z.ai OAuth credentials from the shared Codez credential store."],
      name: "logout",
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.codez/AGENTS.md.",
      ],
      name: "init",
