export type CodezAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly CodezAssistantMessagePart[] | undefined,
  nextPart: CodezAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly CodezAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly CodezAssistantMessagePart[]) {
