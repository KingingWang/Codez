declare module "*.css";
declare module "@codez/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_CODEZ_BASE_URL?: string;
  readonly VITE_CODEZ_ENDPOINT_ORIGIN?: string;
  readonly VITE_CODEZ_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
