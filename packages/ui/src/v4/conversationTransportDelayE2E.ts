import type { CommandAck } from "@codez/shared/codez-protocol-v4";
...
export async function sendWithConversationDelayE2E(
  ...
  const host =
    typeof window === "undefined"
      ? undefined
      : (window as Window & { __codezTransportDelayE2E?: DelayPlan });
  const plan = shouldExposeE2EStoreBridge() ? host?.__codezTransportDelayE2E : undefined;
