...
import type { V4ConversationFileRewindPreviewResult } from "@codez/shared/codez-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useCodezIntl>["intl"]) {
