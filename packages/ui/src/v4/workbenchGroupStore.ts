...
import type { CodezTaskClientMode } from "@codez/shared";
import {
  INITIAL_PANE_LAYOUT,
  MAX_WORKBENCH_PANES,
  V4_PRIMARY_PANE_ID,
...
const WORKBENCH_GROUP_STORAGE_KEY = "codez-v4-session-workbench-groups:v1";
...
interface WorkbenchGroupStore extends WorkbenchGroupSnapshot {
  configureClientMode: (clientMode: CodezTaskClientMode) => void;
...
let workbenchGroupClientMode: CodezTaskClientMode = "desktop-continuous";
