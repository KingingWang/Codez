...
import { useToolbarConfigOptions } from "@/hooks/useCodezConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const thoughtOption = useMemo<CodezConfigOption | null>(() => {
...
import { isApiKeyAccess } from "@codez/provider";
