...
import type { ShortcutCommandId, CodezConfigOption } from "@codez/shared";
import {
...
function getChatToolbarShortcutKey(
  category: CodezConfigOption["category"],
...
export function getNextConfigSelectValue(
  option: Pick<CodezConfigOption, "type" | "currentValue" | "options">,
): string | null {
...
interface ToolbarShortcutState {
  ...
  modelOption?: CodezConfigOption;
  modeOption?: CodezConfigOption;
  thoughtOption?: CodezConfigOption;
}
