...
//
// 旧草稿面（codezSessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@codez/shared";
...
const STORAGE_KEY_PREFIX = "codez-v4-composer-drafts:v1:";
