...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@codez/shared";
import type { CodezAutomationScheduleRule } from "@codez/shared";
...
function isScheduleRule(value: unknown): value is CodezAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as CodezAutomationScheduleRule)
    : undefined;
