...
import type { ApplicationIconRequest } from "@codez/shared";
import { useCodezIntl } from "@/i18n/IntlProvider.js";
import { isCodezCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_codez_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isCodezCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useCodezIntl>["intl"];
