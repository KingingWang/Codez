 ...
 *
 * 一行的读法与模型面
 * （apps/codez-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@codez/shared/codez-protocol-v4";
...
type FormatMessage = ReturnType<typeof useCodezIntl>["intl"]["formatMessage"];
