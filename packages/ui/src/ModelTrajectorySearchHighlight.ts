...
const HIGHLIGHT_NAME = "codez-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "codez-model-trajectory-find-active";
const STYLE_ID = "codez-model-trajectory-find-highlight-style";
