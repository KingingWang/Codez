import type { McpServerStatus, CodezMcpServer, CodezMcpServerStatusSnapshot } from "@codez/shared";
...
function mapRuntimeStatusToUi(snapshot: CodezMcpServerStatusSnapshot): MappedMcpServerStatus {
