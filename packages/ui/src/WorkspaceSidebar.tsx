...
import type { Locale, RemoteTarget, UserInfo, CodezTaskMeta } from "@codez/shared";
import { BUILTIN_MODEL_PROVIDER_IDS } from "@codez/shared";
import {
...
const EMPTY_WORKSPACE_TASK_ITEMS: CodezTaskMeta[] = [];
...
export const WorkspaceSidebar = memo(function WorkspaceSidebarComponent({
  ...
  const bumpTaskListVersion = useCodezSessionStore((state) => state.bumpTaskListVersion);
