...
type IntlShape = ReturnType<typeof useCodezIntl>["intl"];
...
function compactTextPreview(message: CodezModelTrajectoryMessage): string {
...
function firstLinePreview(message: CodezModelTrajectoryMessage): string {
...
function messageClipboardText(message: CodezModelTrajectoryMessage): string {
