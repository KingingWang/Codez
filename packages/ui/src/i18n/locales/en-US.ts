...
const enUS: Record<string, string> = {
  ...
  "titleBar.menu.help.toggleCodezStdioTap": "Capture agent stdio traffic",
  ...
  "settings.codezInteractionBehavior": "Interaction behavior",
  "settings.codezInteractionBehaviorDescription":
    "While Codez is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.codezInteractionBehavior.option.queue": "Queue",
  "settings.codezInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .codez/v2 suffix cannot be changed.",
  ...
  "sidebar.usage.plan.codezMcp": "Codez MCP",
  "sidebar.usage.plan.codezMcpDescription": "Daily aggregate quota for Codez built-in plugin MCPs",
  ...
  "settings.commands.source.codezAgent": "Codez Agent",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .codezignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".codezignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint": "Save first; .codezignore lives at the workspace root",
  ...
  "settingsSync.agent.codez": "Codez Agent",
  ...
  // Codez Agent
  "codez.unavailable": "AI agent not available",
  "codez.initFailed": "Failed to start AI agent",
  "codez.error.TASK_OWNED_BY_OTHER_HOST": "This task is already running in another connected view.",
  "codez.error.STALE_TASK_OWNER_COMMAND": "This action belongs to an older run and was ignored.",
  "codez.error.NO_ACTIVE_TASK_OWNER": "No active task owner is available for this action.",
  "codez.error.OWNER_COMMAND_FAILED": "The task owner could not complete this action.",
  "codez.error.MEDIA_BUDGET_CURRENT_ATTACHMENT_TOO_LARGE":
    "Current attachments are too large for one request. Remove or compress attachments and try again.",
  "codez.error.MEDIA_BUDGET_CURRENT_IMAGE_TOO_LARGE":
    "Current image attachments are too large. Remove or compress images and try again.",
  "codez.error.MEDIA_BUDGET_CURRENT_VIDEO_TOO_LARGE":
    "Current video attachments are too large. Remove or compress videos and try again.",
  "codez.error.CODEZ_RUNTIME_MODEL_UNAVAILABLE":
    "The current model is no longer available. Select an available model from the current model list to continue.",
  "codez.error.CODEZ_BIGMODEL_TEAM_PLAN_MEMBER_REQUIRED":
    "The current model is unavailable. Check whether the current account has been added to the project member list.",
  "codez.error.providerBusiness.1006": "Your login session has expired. Please sign in again.",
  "codez.error.providerBusiness.1005":
    "Today's free plan quota has been used up. Upgrade to continue now, or wait for the quota to reset.",
  "codez.error.providerBusiness.3006":
    "The current model is not included in this plan. Switch to an allowed model and try again.",
  "codez.error.providerBusiness.3002":
    "You're sending requests too quickly. Please try again later.",
  "codez.error.providerBusiness.3001":
    "The request parameters are invalid. Check the input and try again.",
  "codez.error.providerBusiness.3007":
    "The request was rejected by the gateway security check. Please try again later or contact support.",
  "codez.error.providerBusiness.3008":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "codez.error.providerBusiness.3009":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "codez.error.providerBusiness.3010":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "codez.error.providerBusiness.3102":
    "This run exceeded the maximum single-run time. Create a new off-peak task to continue.",
  "codez.error.modelSuspiciousEmpty":
    "The model returned no content (often caused by an expired token or plan issues). Please send again.",
  "codez.error.providerBusiness.2007":
    "The upstream service is temporarily unavailable. Please try again later.",
  "codez.error.providerBusiness.429":
    "You're sending requests too quickly. Please try again later.",
