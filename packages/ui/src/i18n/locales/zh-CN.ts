...
const zhCN: Record<string, string> = {
  ...
  "titleBar.menu.help.toggleCodezStdioTap": "抓取 Agent stdio 通信",
  ...
  "settings.codezInteractionBehavior": "交互行为",
  "settings.codezInteractionBehaviorDescription":
    "在 Codez 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  "settings.codezInteractionBehavior.option.queue": "队列",
  "settings.codezInteractionBehavior.option.guide": "引导",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .codez/v2 不可更改。",
  ...
  "sidebar.usage.plan.codezMcpDescription": "Codez 预置插件 MCP 每日合计额度",
  ...
  "settings.workspaceFileSearch.description":
    "编辑 .codezignore 忽略规则（语法与 .gitignore 一致），控制工作区文件搜索的范围。保存后下次搜索生效。",
  "settings.workspaceFileSearch.templateHint":
    ".codezignore 尚未创建：下方为初始内容预览（.gitignore 拷贝 + 默认排除规则），保存后才会写入工作区。",
  ...
  "settings.workspaceFileSearch.revealHint": "保存后即可在工作区根目录找到 .codezignore",
  ...
  // Codez Agent
  "codez.unavailable": "AI 代理不可用",
  "codez.initFailed": "启动 AI 代理失败",
  "codez.error.TASK_OWNED_BY_OTHER_HOST": "该任务正在另一个已连接视图中运行。",
  "codez.error.STALE_TASK_OWNER_COMMAND": "该操作属于旧的运行轮次，已忽略。",
  "codez.error.NO_ACTIVE_TASK_OWNER": "当前没有可处理该操作的任务所有者。",
  "codez.error.OWNER_COMMAND_FAILED": "任务所有者未能完成该操作。",
  ...
  "codez.error.providerBusiness.1006": "登录状态已失效，请重新登录后再试。",
  "codez.error.providerBusiness.1005":
    "今日免费计划额度已用完。请升级账户、切换模型，或等待额度恢复。",
  "codez.error.providerBusiness.3006": "当前模型不在可用范围内，请切换到允许的模型后重试。",
  "codez.error.providerBusiness.3002": "请求过于频繁，请稍后重试。",
  "codez.error.providerBusiness.3001": "请求参数错误，请检查输入后重试。",
  "codez.error.providerBusiness.3007": "请求被网关安全校验拒绝，请稍后重试或联系支持。",
  "codez.error.providerBusiness.3008": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "codez.error.providerBusiness.3009": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "codez.error.providerBusiness.3010": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "codez.error.providerBusiness.3102": "已超过单次最长运行时间，请创建新的闲时任务继续。",
  "codez.error.modelSuspiciousEmpty": "模型未返回任何内容。",
  "codez.error.providerBusiness.2007": "上游服务暂时不可用，请稍后重试。",
  "codez.error.providerBusiness.429": "请求过于频繁，请稍后重试。",
