...
import type { CodezElicitationQuestion, CodezElicitationRequest } from "@codez/shared";
import type { InteractionAutoResolution } from "@codez/shared/codez-protocol-v4";
...
interface ElicitationDialogProps {
  request: CodezElicitationRequest;
...
interface NormalizedElicitationQuestion extends CodezElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: CodezElicitationRequest): boolean {
