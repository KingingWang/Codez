import type { CodezTaskGroupColor } from "@codez/services";
...
const TASK_GROUP_COLOR_CLASS: Record<CodezTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<CodezTaskGroupColor, string> = {
