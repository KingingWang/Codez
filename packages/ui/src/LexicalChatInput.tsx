...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __codezLexicalInputE2E?: typeof bridge }).__codezLexicalInputE2E === bridge
      ) {
        delete (input as { __codezLexicalInputE2E?: typeof bridge }).__codezLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__codezLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
