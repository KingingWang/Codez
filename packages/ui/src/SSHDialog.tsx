...
import { createUuid, type RemoteTarget, type RemoteWorkspaceSessionEntry } from "@codez/shared";
import {
                ...
                {currentStep === "directory" ? (
                  <div data-testid={TID_SSH_SUCCESS} className="h-full">
                    <RemoteConnectionDirectoryStep
                      ...
                      remoteCodezAgentService={directoryBrowserServices?.codezAgentService ?? null}
