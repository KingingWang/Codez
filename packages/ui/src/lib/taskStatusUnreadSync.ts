...
import type { CodezTaskMeta, CodezWorkspaceTaskListChanged } from "@codez/shared";
...
import { getTaskUnreadIndicator, useCodezSessionStore } from "@/store/codezSessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<ICodezTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: CodezWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: CodezWorkspaceTaskListChanged;
}): boolean {
