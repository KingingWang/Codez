const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "codez-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "codez-notification-sound-enabled";
