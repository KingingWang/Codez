...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-codez-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "codez:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "codez:workspace-file-drag-state";
