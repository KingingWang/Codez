...
import { type CodezProviderAccountAccess, codezProviderAccountAccessSchema } from "@codez/shared";

interface EntitledAccountProviderAccess {
  readonly providerId: string;
  readonly access: CodezProviderAccountAccess;
...
export function resolveEntitledAccountProviderAccess(
  ...
  const parsed = codezProviderAccountAccessSchema.safeParse(provider.effectiveConfig.access);
