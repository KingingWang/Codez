import type { CodezConfigOption, CodezProvider } from "@codez/shared";
...
export function buildAutomationModeOption(currentValue: string): CodezConfigOption {
  return {
    id: "mode",
    name: "Mode",
    category: "mode",
...
export function resolveAutomationModelItem(
  ...
  // workspace runtime 也可能返回 codez-openai-compatible/model 这类包装值，provider 对不上时
...
export function buildAutomationThoughtLevelOption(
  runtimeOption: CodezConfigOption | undefined,
  currentValue: string,
