...
function McpServerItem({
  ...
  server: CodezMcpServer;
  onEdit: (server: CodezMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: CodezMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "codez";
