...
import type { UserCommand, CodezCommand } from "@codez/shared";
import { isPluginCommand, isUserCommand } from "@codez/shared";
...
export function isEditableUserCommand(command: CodezCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "codez";
}

interface CommandCardProps {
  command: CodezCommand;
  onEdit?: (command: CodezCommand) => void;
  onToggle?: (command: CodezCommand, enabled: boolean) => void;
  isOperating?: boolean;
