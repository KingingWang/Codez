import type { McpServerConfig, CodezMcpServer } from "@codez/shared";

export const MCP_SECTIONS = ["codezagentmcp"] as const;
...
export function serverToForm(server: CodezMcpServer): FormState {
...
// 与 shared 层 convertToCodezAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
