import type { CodezPluginComponentKind } from "@codez/shared";
...
const COMPONENT_BADGE_STYLES: Record<CodezPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<CodezPluginComponentKind, string> = {
