...
import type { CodezSavedWorkflowArgType } from "@codez/shared";
...
const ARG_TYPES: readonly CodezSavedWorkflowArgType[] = ["string", "number", "boolean", "json"];
          ...
          >
            <div className={cn("grid items-center gap-3", columns)}>
              ...
              <Select
                value={row.type}
                onValueChange={(value) =>
                  onChange(row.key, { type: value as CodezSavedWorkflowArgType })
                }
              >
