...
import type { CommandConfig, UserCommand, CodezCommand } from "@codez/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: CodezCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: CodezCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? CODEZ_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
