...
import type { McpSource, CodezMcpServer } from "@codez/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: CodezMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: CodezMcpServer) => void;
}) {
  const { intl } = useCodezIntl();
