...
export function CodingPlanStatusPanel({
  ...
  quotaResetAccountAccess?: CodezProviderAccountAccess | CodezAccountAccess;
        ...
        {cards.map((card) => (
          <PlanUsageMetricCard
            ...
            infoDescription={
              card.key === "serverMcp"
                ? intl.formatMessage({
                    id: "sidebar.usage.plan.codezMcpDescription",
                  })
                : undefined
            }
          ...
          {infoDescription ? (
            <ControlHintTooltip title={infoDescription} standalone>
              <button
                ...
                data-codez-mcp-info="model-settings"
              >
