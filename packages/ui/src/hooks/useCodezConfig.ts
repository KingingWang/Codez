/**
 * Codez Agent ConfigOptions 便捷 hooks
 *
...
import type { ConfigOptionsStatus } from "@/store/codezSessionStoreTypes.js";
...
export function useToolbarConfigOptions(
  ...
  const { configOptions, configOptionsStatus } = useCodezSessionStore(
    useShallow((state) => {
