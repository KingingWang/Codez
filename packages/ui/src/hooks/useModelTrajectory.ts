 ...
 *
 * 路径解析与文件读取都收口在 codezTaskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [codezTaskService, taskId, workspaceIdentity, workspacePath, reloadToken]);
