...
import { APP_RUNTIME_PREFERENCES_CHANGED_BROADCAST_CHANNEL, type AppSettings } from "@codez/shared";
...
export function useSettings() {
  const { broadcastService, settingService, codezAgentService } = useServices();
  ...
  const update = useCallback(
    ...
    [broadcastService, settingService, settingsStore, codezAgentService, platform, refresh],
  );
