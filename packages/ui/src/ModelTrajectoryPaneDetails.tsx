...
import type { CodezModelTrajectoryContentPart, CodezModelTrajectoryRecord } from "@codez/services";
...
export function ContentPartView({
  ...
  part: CodezModelTrajectoryContentPart;
  intl: IntlShape;
  sectionLabel?: string;
...
export function summarizeRecords(records: CodezModelTrajectoryRecord[]): {
  totalTokens: number;
  models: string[];
} {
  let totalTokens = 0;
