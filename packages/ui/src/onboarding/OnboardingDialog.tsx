...
export function OnboardingDialog(props: {
  ...
  const onboardingDialogRequested = useCodezStore((state) => state.onboardingDialogRequested);
  const clearOnboardingDialogRequest = useCodezStore((state) => state.clearOnboardingDialogRequest);
      ...
      const confirmed = await confirmDialog({
        ...
        description: intl.formatMessage(
          { id: "onboarding.agentsFile.confirmDescription" },
          {
            ...
            target: agentsFileMigration.status?.targetPath ?? "~/.codez/AGENTS.md",
          },
        ),
