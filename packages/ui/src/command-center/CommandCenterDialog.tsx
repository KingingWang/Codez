...
import { unpackWorkspaceFileEntries } from "@codez/shared/workspaceFileEntriesCodec";
...
import type { WorkspaceFileEntry, CodezTaskChangeSummary, CodezTaskMeta } from "@codez/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = CodezTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = CodezTaskChangeSummary["files"][number];
...
function getTaskTitle(task: CodezTaskMeta, untitledLabel: string): string {
