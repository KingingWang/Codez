...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@codez/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useCodezIntl>["intl"]): string {
  switch (agent) {
    case "codez":
      return intl.formatMessage({ id: "settingsSync.agent.codez" });
    case "claudeCode":
