...
const shouldSkipRemoteAssets = process.env.CODEZ_SKIP_REMOTE_ASSETS === "1";
...
if (isCodexBuild) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (CODEZ_SKIP_REMOTE_ASSETS=1)");
}
