import type { CodezAutomationRunOutcome, CodezAutomationTrigger } from "@codez/shared";
...
interface CronRunLifecycleRepo {
  ...
  markRunOutcome(runId: string, outcome: CodezAutomationRunOutcome, error?: string): Promise<void>;
