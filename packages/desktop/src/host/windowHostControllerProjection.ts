...
import type { CodezArchivedTaskDeletionResult } from "@codez/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: CodezTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | CodezArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: CodezTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
