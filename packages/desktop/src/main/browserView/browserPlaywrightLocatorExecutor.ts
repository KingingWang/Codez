...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@codez/shared";
...
const PLAYWRIGHT_WORLD_NAME = "codez-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__codezPlaywrightInjected";
