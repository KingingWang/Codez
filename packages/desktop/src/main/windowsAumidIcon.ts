...
import type { ApplicationIconInfo } from "@codez/shared";
...
public static class CodezAumidIcon {
...
'@;
$codezIconBytes=[CodezAumidIcon]::Read($codezArg0);
[Console]::Out.Write([Convert]::ToBase64String($codezIconBytes));
`;
