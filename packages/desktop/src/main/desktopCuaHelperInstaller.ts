...
import { HELPER_APP_NAME } from "@codez/codez-cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@codez/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.CODEZ_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
