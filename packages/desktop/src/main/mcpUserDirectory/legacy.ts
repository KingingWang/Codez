...
function buildLegacyCommonMcpStorageCandidates(request?: MigrateLegacyCommonMcpRequest): string[] {
  ...
  candidates.push(join(appData, "ai.z.codez", "store.json"));

  candidates.push(
    join(localAppData, "ai.z.work", "EBWebView", "Default", "Local Storage", "leveldb"),
    join(appData, "Codez", "Local Storage", "leveldb"),
    join(appData, "Codez", "Partitions", "codez-embedded-browser", "Local Storage", "leveldb"),
    join(appData, "Codez Dev", "Local Storage", "leveldb"),
    join(appData, "Codez Dev", "Partitions", "codez-embedded-browser", "Local Storage", "leveldb"),
  );
