...
function buildForceUpdatePromptMessages(locale: Locale) {
  ...
  return {
    ...
    checkingMessage: "Keep this window open while Codez checks for updates.",
    downloadingTitle: "Downloading update",
    downloadingVersionTitle: "Downloading update v{version}",
    downloadingMessage: "Codez will install the update automatically after download.",
    readyTitle: "Update downloaded",
    readyMessage: "Codez is preparing to restart and install the update.",
    installingTitle: "Installing update",
    installingMessage: "Codez will restart to finish installing the update.",
    ...
    <main class="panel" role="dialog" aria-modal="true" aria-labelledby="title">
      <header class="titlebar">
        <div class="brand">
          ...
          <div class="brand-title">Codez</div>
        </div>
