...
function mapMcpTelemetryEvent(event: Exclude<CodezMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<CodezMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
