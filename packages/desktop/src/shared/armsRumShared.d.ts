import { type CodezRuntimeEnv } from "@codez/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: CodezRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@codez/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
